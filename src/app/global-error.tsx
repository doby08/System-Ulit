...
/**
 * Root error boundary — the LAST resort when the app tree itself throws.
 * Without this file Next rendered its default page (or nothing), which looked
 * like a black screen with no way to get back to sign-in.
 */
